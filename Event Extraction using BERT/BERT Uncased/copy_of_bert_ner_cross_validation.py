# -*- coding: utf-8 -*-
"""Copy of Bert_NER_Cross_Validation.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1S2fBfbj5HSqrrSFr0HBMuJOiP7ND9MQD
"""
...
sentences_original = [" ".join([s[0] for s in sent]) for sent in getter.sentences]
sentences_original[0]

labels_original = [[s[1] for s in sent] for sent in getter.sentences]
print(labels_original[0])

tags_vals = list(set(data["Tag"].values))
tag2idx = {t: i for i, t in enumerate(tags_vals)}

X = np.array(sentences_original, dtype = object)
y = np.array(labels_original, dtype = object)
...
for train_index, test_index in kf.split(X):
  ...
  tokenized_texts_train = [tokenizer.tokenize(sent) for sent in X_train]
  tokenized_texts_test = [tokenizer.tokenize(sent) for sent in X_test]
  ...
  tr_tags = pad_sequences([[tag2idx.get(l) for l in lab] for lab in y_train],
                      maxlen=MAX_LEN, value=tag2idx["O"], padding="post",
                      dtype="long", truncating="post")
  val_tags = pad_sequences([[tag2idx.get(l) for l in lab] for lab in y_test],
                      maxlen=MAX_LEN, value=tag2idx["O"], padding="post",
                      dtype="long", truncating="post")
  ...
  for _ in trange(epochs, desc="Epoch"):
      ...
      print ("this is {} cross fold iteration".format(count))
...
#EVALUATION OF SECTIME ENTITIES
