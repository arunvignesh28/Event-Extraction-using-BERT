...
class NerProcessor(DataProcessor):
    ...
    def get_labels(self):
        return ['i-EVIDENTIAL', 'b-EVIDENTIAL', 'i-DATE', 'b-DATE', 'i-OCCURRENCE', 'b-OCCURRENCE', 'i-TIME', 'b-TIME', 'i-TREATMENT', 'b-TREATMENT', 'i-CLINICAL_DEPT', 'b-CLINICAL_DEPT', 'i-FREQUENCY', 'b-FREQUENCY', 'i-DISCHARGE', 'b-DISCHARGE', 'i-DURATION', 'b-DURATION', 'i-PROBLEM', 'b-PROBLEM', 'i-TEST', 'b-TEST', 'i-ADMISSION', 'b-ADMISSION', 'O', "[CLS]", "[SEP]", "X"] 
...
def create_model(bert_config, is_training, input_ids, input_mask,
    ...
    with tf.variable_scope("loss"):
        ...
        logits = tf.reshape(logits, [-1, FLAGS.max_seq_length, 29])
    ...
    def model_fn(features, labels, mode, params):
        ...
        if mode == tf.estimator.ModeKeys.TRAIN:
            ...
            # def metric_fn(label_ids, logits):
                ...
                precision = tf_metrics.precision(label_ids,predictions,29,[1,2],average="macro")
                recall = tf_metrics.recall(label_ids,predictions,29,[1,2],average="macro")
                f = tf_metrics.f1(label_ids,predictions,29,[1,2],average="macro")
                #
                return {
